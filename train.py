...
from NACE import NACE, save_model_and_optstate, load_model_and_optstate
...
def load_and_flatten_data(cfg: NACEConfig, model: NACE):
...
def loss_func(model: NACE, x, y, action_map, i_in, i_out, key):
...
@eqx.filter_jit
def train_chunk(model: NACE, opt_state, key, seq_length, chunk_size, load_vram, all_x, all_y, all_a, all_i_in, all_i_out):
