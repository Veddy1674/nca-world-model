...
BATCH_SIZE = 64
LOG_SEGMENTS = 100
LOAD_MODEL = None#"mario2/model1.eqx"
SAVE_MODEL = "mario2/model1.eqx"
...
# visualizer
LOAD_MODEL_INF = "mario2/model1.eqx"
LOAD_DATA_INF = "mario2/data/example_0000.npz"
DATA_IDX_INF = 0
...
def loss_calc(vis_preds: jnp.ndarray, hid_preds: jnp.ndarray, targets: jnp.ndarray, actions: jnp.ndarray, infos: jnp.ndarray) -> jnp.ndarray:
    ...
    return celoss + hid_loss * 0.1# + mse_loss + bg_loss * 0.1
